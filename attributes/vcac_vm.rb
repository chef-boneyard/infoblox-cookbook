# Reserve static IP
default['vcac_vm_static_ip']['name'] = 'clogeny06'
default['vcac_vm_static_ip']['ipv4addr'] = '172.26.1.6'
default['vcac_vm_static_ip']['hostname'] = 'clogeny06.demo.com'
...
default['vcac_vm_static_ip']['usage_type'] = 'fixed_address'
default['vcac_vm_static_ip']['record_type'] = 'A'

# Reserve IP in network
default['vcac_vm_network_ip']['name'] = 'clogeny06'
default['vcac_vm_network_ip']['hostname'] = 'clogeny06.demo.com'
default['vcac_vm_network_ip']['mac'] = ''
default['vcac_vm_network_ip']['network'] = '172.26.1.0/24'
default['vcac_vm_network_ip']['exclude'] = %w(172.26.1.1 172.26.1.2)
...
# Reserve IP in range
default['vcac_vm_range_ip']['name'] = 'clogeny06'
default['vcac_vm_range_ip']['hostname'] = 'clogeny06.poc.infobloxdemo.com'
...
default['vcac_vm_range_ip']['usage_type'] = 'host'
